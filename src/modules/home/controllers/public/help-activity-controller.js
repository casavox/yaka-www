        ...
        vm.activities = [
            {
                ...
                "subText": [
                    ...
                    {"q": "Trouver un peintre sérieux, dont la confiance est garantie par votre entourage, grâce à CasaVox !"},
                    {"l": "Garanti sans spam et aucune de vos informations personnelles ne sortira de CasaVox :"},
                    {"l": "Échanger en toute sécurité et très simplement avec chaque peintre professionnel susceptible d’intervenir chez vous et surtout décider à qui et quand vous diffusez vos coordonnées personnelles. Vous pouvez alors choisir en toute confiance le peintre qui correspond le plus à vos attentes."},
                    {"l": " "},
            ...
            },
            {
                ...
                "subText": [
                    ...
                    {"q": "Trouver un professionnel sérieux, dont la confiance est garantie par votre entourage, grâce à CasaVox !"},
                    {"l": "Garanti sans spam et aucune de vos informations personnelles ne sortira de CasaVox :"},
                    {"l": "Échanger en toute sécurité et très simplement avec chaque artisan susceptible d’intervenir chez vous et surtout décider à qui et quand vous diffusez vos coordonnées personnelles. Vous pouvez alors choisir en toute confiance l'artisan qui correspond le plus à vos attentes."},
                    {"l": " "},
                    {"p": "CasaVox vous permet de conserver l’historique de vos échanges (messages, photos, devis, …) et de rester en contact avec le Pro que vous aurez retenu, pour de futurs travaux et pour le recommander à votre tour dans vos cercles d’amis, de collègues et de voisinage."},
                    {"b": "CasaVox encourage la recommandation de professionnels du bâtiment entre proches, à chaque fois qu’un de vos proches suit votre recommandation : vous pouvez gagner 10€"},
                    {"l": "(référez-vous aux CGU pour plus d'informations)."},
            ...
            },
            {
                ...
                "subText": [
                    ...
                    {"q": "Trouver un cuisiniste sérieux, dont la confiance est garantie par votre entourage, grâce à CasaVox !"},
                    {"l": "Garanti sans spam et aucune de vos informations personnelles ne sortira de CasaVox :"},
                    {"l": "Échanger en toute sécurité et très simplement avec chaque artisan susceptible d’intervenir chez vous et surtout décider à qui et quand vous diffusez vos coordonnées personnelles. Vous pouvez alors choisir en toute confiance le cuisiniste qui correspond le plus à vos attentes."},
                    {"l": " "},
                    {"p": "CasaVox vous permet de conserver l’historique de vos échanges (messages, photos, devis, …) et de rester en contact avec le Pro que vous aurez retenu, pour de futurs travaux et pour le recommander à votre tour dans vos cercles d’amis, de collègues et de voisinage."},
                    {"b": "CasaVox encourage la recommandation de professionnels du bâtiment entre proches, à chaque fois qu’un de vos proches suit votre recommandation : vous pouvez gagner 10€"},
                    {"l": "(référez-vous aux CGU pour plus d'informations)."},
            ...
            },
            {
                ...
                "subText": [
                    ...
                    {"q": "Trouver un électricien sérieux, dont la confiance est garantie par votre entourage, grâce à CasaVox !"},
                    {"l": "Garanti sans spam et aucune de vos informations personnelles ne sortira de CasaVox :"},
                    {"l": "Échanger en toute sécurité et très simplement avec chaque artisan électricien susceptible d’intervenir chez vous et surtout décider à qui et quand vous diffusez vos coordonnées personnelles. Vous pouvez alors choisir en toute confiance l’électricien qui correspond le plus à vos attentes."},
                    {"l": " "},
                    {"p": "CasaVox vous permet de conserver l’historique de vos échanges (messages, photos, devis,…) et de rester en contact avec le Pro que vous aurez retenu, pour de futurs travaux et pour le recommander à votre tour dans vos cercles d’amis, de collègues et de voisinage."},
                    {"b": "CasaVox encourage la recommandation de professionnels du bâtiment entre proches, à chaque fois qu’un de vos proches suit votre recommandation : vous pouvez gagner 10€"},
                    {"l": "(référez-vous aux CGU pour plus d'informations)."},
            ...
            },
            {
                ...
                "subText": [
                    ...
                    {"q": "Trouver un plombier sérieux, dont la confiance est garantie par votre entourage, grâce à CasaVox !"},
                    {"l": "Garanti sans spam et aucune de vos informations personnelles ne sortira de CasaVox :"},
                    {"l": "Échanger en toute sécurité et très simplement avec chaque artisan susceptible d’intervenir chez vous et surtout décider à qui et quand vous diffusez vos coordonnées personnelles. Vous pouvez alors choisir en toute confiance le plombier qui correspond le plus à vos attentes."},
                    {"l": " "},
                    {"p": "CasaVox vous permet de conserver l’historique de vos échanges (messages, photos, devis,…) et de rester en contact avec le Pro que vous aurez retenu, pour de futurs travaux et pour le recommander à votre tour dans vos cercles d’amis, de collègues et de voisinage."},
                    {"b": "CasaVox encourage la recommandation de professionnels du bâtiment entre proches, à chaque fois qu’un de vos proches suit votre recommandation : vous pouvez gagner 10€"},
                    {"l": "(référez-vous aux CGU pour plus d'informations)."},
            ...
            },
            {
                ...
                "subText": [
                    ...
                    {"b": "« Connaissez-vous un bon Pro pour la réparation ou l'installation d'une véranda ? »"},
                    {"l": " "},
                    {"l": "CasaVox s’inspire de la “vraie vie” en portant sur internet le principe de bouche-à-oreille :"},
            ...
            },
            {
                ...
                "subText": [
                    ...
                    {"q": "Trouver un professionnel sérieux, dont la confiance est garantie par votre entourage, grâce à CasaVox !"},
                    {"l": "Garanti sans spam et aucune de vos informations personnelles ne sortira de CasaVox :"},
                    {"l": "Échanger changer rapidement, en toute sécurité et très simplement avec chaque serrurier susceptible d’intervenir chez vous et surtout décider à qui et quand vous diffusez vos coordonnées personnelles. Vous pouvez alors choisir en toute confiance le serrurier qui correspond le plus à vos attentes."},
                    {"l": " "},
                    {"p": "CasaVox vous permet de conserver l’historique de vos échanges (messages, photos, devis, …) et de rester en contact avec le Pro que vous aurez retenu, pour de futurs travaux et pour le recommander à votre tour dans vos cercles d’amis, de collègues et de voisinage."},
                    {"b": "CasaVox encourage la recommandation de professionnels du bâtiment entre proches, à chaque fois qu’un de vos proches suit votre recommandation : vous pouvez gagner 10€"},
                    {"l": "(référez-vous aux CGU pour plus d'informations)."},
            ...
            {
                "urlTitle": "revetement",
                "title1": "Revêtement sur sol ou mur",
                "imgUrl": "img/works_categories/Sol_carrelage.jpg",
                "title2": "Intérieur ou extérieur, mur, sol ou plafond, parquet, dallage, peinture, terrasse, papier peint, ... Vous avez des travaux de revêtement ?",
                "paragraphs": [
                    {"l": "Quelle que soit l’ampleur des travaux à réaliser, raffraichir des murs ou en changer la couleur, poser une moquette, rénover un parquet, raffraichir un dallage, installer une terrasse, ... Que ce soit pour de petits ou gros travaux sur des revêtements de sols ou des revêtements de murs, ne vous improvisez pas professionnel des travaux, il existe des règles et des bonnes pratiques à suivre pour réaliser des travaux durables et de qualité :"},
                    {"l": " "},
                    {"tags": ["Carrelage", "Faïence", "Vitrification d'un parquet", "Marbre", "Béton", "Moquette", "Pierres naturelles", "Lino.®", "Chape", "Terrasse", "Pierres reconstituées", "Margelle", "Peinture", "..."]},
                    {"b": "Le mieux est de faire appel à un professionnel du bâtiment offrant toutes les garanties !"},
                ...
                "subText": [
                    ...
                    {"q": "Trouver un professionnel sérieux, dont la confiance est garantie par votre entourage, grâce à CasaVox !"},
                    {"l": "Garanti sans spam et aucune de vos informations personnelles ne sortira de CasaVox :"},
                    {"l": "Échanger rapidement, en toute sécurité et très simplement avec chaque artisan susceptible d’intervenir pour poser vos nouveaux revêtements de sol, ou revêtement de murs et grâce à CasaVox, vous seul décidez à qui et quand vous diffusez vos coordonnées personnelles."},
                    {"l": " "},
                    {"p": "CasaVox vous permet de conserver l’historique de vos échanges (messages, photos, devis, …) et de rester en contact avec le Pro que vous aurez retenu, pour de futurs travaux et pour le recommander à votre tour dans vos cercles d’amis, de collègues et de voisinage."},
                    {"b": "CasaVox encourage la recommandation de professionnels du bâtiment entre proches, à chaque fois qu’un de vos proches suit votre recommandation : vous pouvez gagner 10€"},
                    {"l": "(référez-vous aux CGU pour plus d'informations)."},
