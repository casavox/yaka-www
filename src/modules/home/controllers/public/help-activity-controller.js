    ...
    function HelpActivityController($scope, $rootScope, networkService, alertMsg, $localStorage, $state, $translate, $auth, $stateParams) {
        ...
        vm.activities = [
            ...
            },
            {
                ...
                "title": "Menuiserie - Oise",
                "imgUrl": "../../../img/works_categories/Menuiserie_oise.png",
                "paragraphs": [
                    {"p": "Dans la catégorie menuiserie, fenêtre et véranda, concernant la région de Compiègne dans l’Oise, retrouvez tous les travaux concernant l’installation, la réparation et la rénovation d’une baie coulissante double vantaux (2 vantaux), de fenêtre double vantaux, d’un volet roulant électrique, d’un volet roulant manuel ou de mécanisme de volet roulant (motorisation de volet roulant) on retrouve également des projets de travaux de pose d'un volet roulant manuel, solaire ou store, de fenêtre de toit (type velux), d’un store banne motorisé ou manuel, ainsi que la pose, la réparation ou la rénovation d’une porte de garage coulissante, et dee porte de garage sectionnable, portes de garage manuel ou motorisé avec télécommande et capteur de présence."},
                    ...
                    {"p": "Pour toute question ou remarque concernant la recherche d’un menuisier pour vos travaux sur la région de Compiègne n’hésitez pas à nous joindre via le Support CasaVOX."},
                    {"p": ""},
